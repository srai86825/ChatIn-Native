// import {EXPO_PUBLIC_HOST_SERVER} from "react-native-dotenv"

export const HOST_SERVER =
  process.env.EXPO_PUBLIC_HOST_SERVER || "https://chatin-server.onrender.com";
...
export const FETCH_STORIES_ROUTE = `${STORIES_ROUTE}/fetch-all-stories/`;
export const ADD_STORY_ROUTE = `${STORIES_ROUTE}/add-story`;

export const FETCH_FEED_ROUTE = `${FEEDS_ROUTE}/fetch-feed`;
export const ADD_POLL_ROUTE = `${FEEDS_ROUTE}/add-poll`;
